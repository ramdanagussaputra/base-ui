...
export const createFieldsetSelectOptionWithSelectedState =
  ...
  (props: OptionProps<unknown, boolean, GroupBase<unknown>>) => {
    ...
    return (
      <div
        className={cn(
          "flex w-full cursor-pointer items-center justify-between rounded-md bg-transparent px-3 py-2.5 text-(length:--fieldset-select-option-font-size)! leading-(--fieldset-select-option-line-height)! font-(--fieldset-select-option-font-weight)! font-normal! duration-150! hover:bg-(--fieldset-select-option-bg--hover)",
          {
            // Disabled/Already selected styling
            "cursor-not-allowed !bg-gray-50 opacity-60 hover:!bg-gray-50":
              isAlreadySelected,
