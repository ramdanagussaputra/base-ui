...
export function FieldsetAsyncPaginate({
  ...
  const showClearIndicator = !isMultiSelect && !!value;

  return (
    <div className="relative flex items-center overflow-hidden [&>div]:flex-1">
      <AsyncPaginate
      ...
      {showClearIndicator && (
        <Icon
          ...
          className="text-secondary-500 absolute right-7.5 size-5 rotate-45 cursor-pointer"
        />
      )}
    </div>
  );
